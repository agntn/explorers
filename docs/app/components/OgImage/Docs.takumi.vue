...
/** Full tool names as constants: static text next to an interpolation renders outside the chip in Takumi. */
const CHIPS = ["explorers_balance", "explorers_tx_history", "explorers_contract", "explorers_gas"];
</script>
  ...
  >
    ...
    <div class="flex items-center justify-between w-full">
      <div class="flex items-center">
        <div class="w-[10px] h-[10px] rounded-full" style="background-color: #6ee7b7" />
        <p
