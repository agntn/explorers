...
<template>
  <div class="explorers-landing not-prose">
    ...
    >
      ...
      >
        Fourteen explorers. <span class="text-primary whitespace-nowrap">One shape.</span>
      </h1>
      <p
        class="explorers-enter explorers-enter-2 mx-auto mt-6 max-w-xl text-base leading-7 text-muted"
      >
        Etherscan, Blockscout, Mempool, Solscan, Koios, dcrdata and eight more behind one
        TypeScript contract. Balances, transactions, unspent outputs, tokens, contracts, gas and
        blocks on 24 chains, amounts as exact strings, and a provider picked for you from the keys
    ...
    <LandingFeature
      eyebrow="Providers"
      title="Fourteen backends, honest about what they serve"
      to="/providers"
      link="All providers"
      :checks="[
