...
const description =
  "Which of the eighteen providers the docs worker holds a key for and what each one serves. Never the key itself, just configured or not.";
...
defineOgImage(
  ...
  { alt: "Providers: what the docs worker can answer" },
);
</script>
