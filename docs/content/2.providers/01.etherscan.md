...
- Five requests a second on the free tier, and Etherscan counts them. Past that you get a rate limit message dressed up as a normal answer; the provider turns it into `RateLimitError` and an automatic selection moves the read to Blockscout, once.
