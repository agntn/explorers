...
- Registry metadata must stay answerable without importing provider modules.
- Explicit provider choices remain strict; automatic routing may use only documented fallback rules.
